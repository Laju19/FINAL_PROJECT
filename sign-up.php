...
<h1 style="text-align: center; color: pink; background-color: #333;"> LAJU'S SALON <br>SIGN UP PAGE</h1>
                    ...
                    <div class="card-body">
                        <form action="backend/user-signup.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="full-name" class="form-control" name="full-name" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="username" class="col-md-4 col-form-label text-md-right">Phone number</label>
                                <div class="col-md-6">
